              ...
              <div class="card card-plain">
                ...
                <div class="card-body mt-2">
                  <form role="form">
                    ...
                    <div class="text-center">
                      <a href="dashboard"><button type="button" class="btn btn-lg bg-gradient-dark btn-lg w-100 mt-4 mb-0">Sign
                          in</button></a>
                    </div>
                  </form>
                </div>
                ...
                <div class="card-footer text-center pt-0 px-sm-4 px-1">
                  ...
                  <p class=" text-sm mx-auto">
                    ...
                    <a href="javascript:;" class="glcolor-primary  font-weight-bold">Sign
                      up</a>
                  </p>
                ...
                <div class="dropdown">
                  <button class="col-12 btn bg-gradient-secondary  dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                    other users
                  </button>
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <!-- <li><a class="dropdown-item" href="admin_dashboard">Admin</a></li> -->
                    <li><a class="dropdown-item" href="hotel_dashboard">Hotel</a></li>
                  </ul>
                </div>
              </div>
            </div>
