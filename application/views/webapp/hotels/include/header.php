  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-pri mary  bg-gradient-light text-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark <?php echo ($menu == 'hotel_dashboard') ? 'active bg-dark' : ''; ?> " href="hotel_dashboard">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark <?php echo ($menu == 'hotel_creation') ? 'active bg-dark' : ''; ?> " href="hotel_creation">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons ms-1 opacity-10">menu_book</i>
            </div>
            <span class="nav-link-text ms-2">Hotel Reg</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link text-dark <?php echo ($menu == 'hotel_creation_details') ? 'active bg-dark' : ''; ?> " href="hotel_creation_details">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons ms-1 opacity-10">menu_book</i>
            </div>
            <span class="nav-link-text ms-2">Add Details</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link text-dark <?php echo ($menu == 'hotel_facilitys') ? 'active bg-dark' : ''; ?> " href="hotel_facilitys">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons ms-1 opacity-10">menu_book</i>
            </div>
            <span class="nav-link-text ms-2">Facilitys</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link text-dark <?php echo ($menu == 'hotel_tourist_place') ? 'active bg-dark' : ''; ?> " href="hotel_tourist_place">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons ms-1 opacity-10">menu_book</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-dark <?php echo ($menu == 'hotel_viewpoints') ? 'active bg-dark' : ''; ?> " href="hotel_viewpoints">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons ms-1 opacity-10">menu_book</i>
            </div>
            <span class="nav-link-text ms-2">Viewpoints</span>
          </a>
        </li>

        <!-- <li class="nav-item">
          <a data-bs-toggle="collapse" href="#category" class="nav-link text-dark <?php echo ($menu == 'add_hotel_hotel_creation' || $menu == 'all_hotel') ? 'active bg-dark' : ''; ?>" aria-controls="category" role="button" aria-expanded="false">
            <i class="material-symbols-outlined  opacity-10">menu_book</i>
            <span class="nav-link-text ms-2 ">Hotel Reg</span>
          </a>
          <div class="collapse  <?php echo ($menu == 'add_hotel_hotel_creation' || $menu == 'all_hotel') ? 'show' : ''; ?> " id="category">
            <ul class="nav ">
              <li class="nav-item ">
                <a class="nav-link text-dark <?php echo ($menu == 'add_hotel_hotel_creation') ? 'active' : ''; ?>" href="add_hotel_hotel_creation">
                  <span class="sidenav-mini-icon"> CC </span>
                  <span class="sidenav-normal  ms-2  ps-1">Add Hotel  Details </span>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link text-dark <?php echo ($menu == 'all_hotel') ? 'active' : ''; ?>" href="all_hotel">
                  <span class="sidenav-mini-icon"> AC </span>
                  <span class="sidenav-normal  ms-2  ps-1"> All Hotel </span>
                </a>
              </li>
