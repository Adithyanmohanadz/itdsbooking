        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <div class="d-lg-flex">
                        <div>
                            <h5 class="mb-0">Category of establishment List </h5>
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                ...
                                <a href="category_establishment_creation" class="btn bg-gradient-dark btn-sm mb-0">+ Add Category of establishment</a>
                        ...
                        <table class="table table-flush" id="category-list">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="  text-uppercase text-secondary text-xs font-weight-bolder ">Category of establishment</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class=""> 
                                            <h6 class="ms-3 my-auto text-wrap text-break">Category of establishment</h6> 
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="w-30"> 
                                            <h6 class="ms-3 my-auto">Category of establishment</h6> 
                                    </td>
                                    <td class="align-middle text-center text-sm w-10">
                                        <div class="form-check form-switch">
