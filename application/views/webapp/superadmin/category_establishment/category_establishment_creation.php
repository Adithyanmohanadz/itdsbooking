                        ...
                        <div class="card-body">
                            <form action="">
                                ...
                                <div class="border-radius-xl bg-white">
                                    <h5 class="font-weight-bolder mb-2">Category of establishment</h5>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-6">
                                                <div class="input-group input-group-static ">
                                                    <label class=" "> Category of establishment</label>
                                ...
                                <div class="button-row d-flex mt-4">
                                    <a href="all_category_establishment" class="ms-auto mb-0">
