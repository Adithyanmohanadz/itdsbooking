                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                ...
                                <a href="category_creation" class="btn bg-gradient-dark btn-sm mb-0">+ Add Region</a>
                        ...
                        <table class="table table-flush" id="category-list">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="  text-uppercase text-secondary text-xs font-weight-bolder ">Region</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td> 
                                            <h6 class="ms-3 my-auto">Region</h6> 
                                    </td>
