                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                ...
                                <a href="facilities_creation" class="btn bg-gradient-dark btn-sm mb-0">+ Add Facilities</a>
                        ...
                        <table class="table table-flush" id="sub-category-list">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="  text-uppercase text-secondary text-xs font-weight-bolder ">Facilities Type</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                             <h6 class="ms-3 my-auto">Facilities Type</h6>
                                        </div>
                                    </td>
